            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-text-secondary">Your recent property analyses and locations</p>
                    </div>
                </div>
                {history.length > 0 && (
                    <button
                        ...
                        {history.map((item, idx) => (
                            ...
                            >
                                ...
                                <div className="flex items-start gap-3">
                                    <div className={`p-2 rounded-lg ${item.risk_score ? 'bg-brand-primary/10 text-brand-primary' : 'bg-surface-elevated text-text-secondary'}`}>
                                        ...
                                        <div className="flex items-center justify-between mt-2">
                                            ...
                                            {item.risk_score !== null && (
                                                <div className="flex items-center gap-1">
                                                    <span className={`text-[10px] font-bold ${item.risk_score > 70 ? 'text-red-500' : item.risk_score > 40 ? 'text-yellow-500' : 'text-green-500'}`}>
